...
export const INDIA_LEGACY = [
  {
    ...
    subtitle: "Sanctuaries of Learning",
    desc: "Centuries before modern schooling, ancient universities prioritized slow, deep study over frantic testing. Learning was treated as a lifelong ritual of self-discovery, not a race.",
  },
  {
    icon: '🌿',
    title: 'Ayurveda',
    subtitle: 'The Science of Life',
    desc: "Long before burnout became normal, Ayurveda treated rest as intelligence. It teaches us that our bodies are not machines to be optimized, but natural systems that need seasonal rest.",
  },
  {
    icon: '🧘',
    title: 'Yoga & Dhyana',
    subtitle: 'Quiet Strength',
    desc: "Stillness was once considered a form of strength. Codified 2,500 years ago, yoga was never about performance or fitness—it was a practice of learning how to sit quietly with your own mind.",
  },
  {
    icon: '🔢',
    title: 'Mathematics & Zero',
    subtitle: 'The Power of Nothing',
    desc: "By formalizing zero, ancient Indian mathematicians proved that 'nothing' is not empty—it holds the power to transform everything. Your moments of doing nothing are just as vital.",
  },
  {
    icon: '📜',
    title: 'Upanishads & Self',
    subtitle: "Inner Space",
    desc: "Humanity's oldest philosophical texts didn't look outward for answers. They realized the ultimate sanctuary is already inside you, waiting behind the noise of daily life.",
  },
  {
    icon: '⭐',
    title: 'Astronomy & Cycles',
    subtitle: 'Cosmic Rhythm',
    desc: "Before clock towers and calendars, early skywatchers mapped the stars to sync human routines with cosmic cycles. They understood that aligning with the universe brings peace.",
  },
]
